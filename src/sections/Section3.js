...
{/* --------------------SMALL SCREENS-------------- */}
        <section className="sctn_three_small">
            <Container>
                ...
                <Row>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="HTML"> <FaHtml5 className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="CSS"> <FaCss3Alt className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            
                            
                </Row>

                <Row>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Javascript"> <SiJavascript className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Bootstrap"> <FaBootstrap className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                ...
                <Row>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="React"> <FaReact className="skillicon"  color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Redux"> <SiRedux className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                ...
                <Row>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Nodejs"> <FaNode className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="MongoDB"> <SiMongodb className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            

                </Row>
                <Row>
                <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Git"> <DiGit className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="C++"> <SiCplusplus className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            
                </Row>
                
                <Row>
                <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="Python"> <FaPython className="skillicon" color="#5429cf" fontSize="40px" /></div></Col>
                            <Col> <div className="skillcol" data-tooltip="top" role="tooltip" aria-label="AdobeXd"> <SiAdobexd className="skillicon"  color="#5429cf" fontSize="40px" /></div></Col>
                </Row>
                </div>
